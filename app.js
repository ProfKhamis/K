...
const aiO1U8WindowInput = document.getElementById('ai-o1u8-window');
const aiO1U8ThresholdInput = document.getElementById('ai-o1u8-threshold');
const aiO1U8StatusPanel = document.getElementById('ai-o1u8-status');
const aiO1U8OverDangerDisplay = document.getElementById('ai-o1u8-over-danger');
const aiO1U8UnderDangerDisplay = document.getElementById('ai-o1u8-under-danger');
...
const AI_O1U8_INPUT_IDS = [
    ...
    'ai-o1u8-stop-loss', 'ai-o1u8-window', 'ai-o1u8-threshold'
];

let isAIO1U8Running = false;
let aiO1U8DigitWindow = [];
...
// --- AI OVER 1/UNDER 8 (decision engine: Over 1 / Under 8 / Wait) ---
// Rule-based and fully transparent: picks whichever side's "danger digits" (0/1 for Over 1,
...
function evaluateAIO1U8Entry() {
    ...
    if (aiO1U8DigitWindow.length < windowSize) {
        if (aiO1U8StatusText) { aiO1U8StatusText.textContent = 'Collecting data...'; aiO1U8StatusText.className = 'system-msg'; }
        return;
    }
...
btnRunAIO1U8.addEventListener('click', () => {
    ...
    if (aiO1U8OverDangerDisplay) aiO1U8OverDangerDisplay.textContent = '--';
    if (aiO1U8UnderDangerDisplay) aiO1U8UnderDangerDisplay.textContent = '--';
    if (aiO1U8StatusText) { aiO1U8StatusText.textContent = 'Collecting data...'; aiO1U8StatusText.className = 'system-msg'; }
